...
- 单词种别
  ...
  **通常用整数编码表示，表示单词的种类**，它是语法分析所需要的信息。
  ...
  ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/22.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/24.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/23.png)
...
1. 把词法分析程序**做为主程序**
   ...
   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/25.png)

2. 把词法分析程序**做为子程序**

   每当语法分析程序需要一个单词时，则调用该子程序。词法分析程序每得到一次调用，便从源程序文件中读入一些字符，直到识别出一个单词，或说直到下一单词的第一个字符为止。

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/26.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/27.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/28.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/29.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/30.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/33.png)

将上述状态转换图转换成状态转换矩阵，如下图表示

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/34.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/31.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/32.png)

对于$\Sigma ^*$中的任何字 $\alpha$，若存在一条从初态到某一终态的道路，且这条路上所有弧上的标记符连接成的字等于 $\alpha$，则称 $\alpha$为 DFA M 所**识别** ( **接收** )。

DFA M 所识别的字的全体记为L(M)。

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/35.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/36.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/37.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/44.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/45.png)
...
- ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/46.png)
- ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/47.png)
- ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/48.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/49.png)
...
2. 设 $a$ 是 $\Sigma$ 中的一个字符，定义 $I_a=\varepsilon -closure(J)$。其中， $J$ 为 $I$ 中的某个状态出发经过一条 $a$ 弧而到达的状态集合。
   ...
   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/38.png)

3. 例如：

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/39.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/40.png)

构造的转换表如下图所示

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/41.png)

下图中划红线的是初态，蓝线的是终态

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/42.png)

把转换表变成相应的状态转换矩阵和DFA M'

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/43.png)
...
2. 对当前划分出的$I^{(1)},I^{(2)},\cdots,I^{(m)}$子集进行划分。划分依据：对某个 $I^{(i)}=\{s_1 ,s_2 ,\cdots ,s_k \}$，若存在一个输入字符 $a$ 使得 $I_a^{(i)}$ **不全包含**在当前划分的某个子集 $I^{(i)}$ 中，则至少应把 $I^{(i)}$ 分为两个部分。
   ...
   - 划分依据：
     ...
     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/62.png)
     ...
     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/63.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/64.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/65.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/66.png)
...
2. 然后，反复使用下面的规则，逐步消去的所有结点，直到只剩下 X 和 Y 为止；
   ...
   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/50.png)

   例如：

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/51.png)
...
1. 若 r 具有零个运算符，则 $r= \varepsilon$ 或 $r=\Phi$ 或 $r=a$，其中 $a\in \Sigma$。
   ...
   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/52.png)
...
2. 若 r 中含有 $k(k\geqslant 1)$ 个运算符时， r 有三种情形 ：
   ...
   - 情形1：$r=r_1 |r_2$， $r_1$ 和 $r_2$ 中运算符个数少于 k 。
     ...
     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/53.png)

     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/54.png)

   - 情形2：$r=r_1 r_2$。

     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/55.png)

     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/56.png)

   - 情形3： $r=r_1 ^*$ 。
   
     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/57.png)
   
     ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/58.png)
...
1. 构造 $\Sigma$ 上的 NFA M' 使得 L(V)=L(M')
   ...
   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/59.png)

2. 按下面的三条规则对 V 进行分裂

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/60.png)

3. 逐步把这个图转变为每条弧只标记为 $\Sigma$ 上的 一个字符或 $\varepsilon$，最后得到一个 NFA M' ， 显然 L(M')=L(V)

以下是将正规式转换成有限自动机的示例：

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/61.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/67.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/68.png)
