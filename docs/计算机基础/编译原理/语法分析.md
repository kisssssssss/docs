...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/69.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/70.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/71.png)
...
>
>    ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/72.png)
>
> 2. 文法 $G_1 (A)$ ： $A \to c|Ab$ ，$G_1(A)$的语言是什么 ?
>
>    $L(G_1)=\{c ， cb ， cbb ，\cdots \}$
>
>    ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/73.png)
>
> 3. 文法 $G_2 (S)$： $S \to AB$，$A \to aA|a$，$B \to bB|b$，$G_2 (S)$的语言是什么 ?
>
>    $L(G_2 )=\{a^mb^n|m , n>0\}$
>
>    ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/74.png)
>
...
>
>   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/75.png)
>
>2. 给出产生语言为 $\{a^mb^n |1\leqslant n\leqslant  m\leqslant 2n\}$ 的文法
>
>   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/76.png)
>
...
>
>    ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/77.png)
>
> 2. 下图的推导树是文法G的句型aabbaa的推导过程。
>
>    把aabbaa叫做推导树的结果，把推导树叫做句型aabbaa的语法树。
>
>    ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/79.png)
...
> 例：
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/78.png)
>
> <br>
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/80.png)
...
2. 构造一个等价的无二义性文法。通过添加新的非终结符来消除文法中的二义性。
   ...
   > 例：将文法G改写为无二义性的文法$G'$
   >
   > ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/81.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/83.png)

语法分析的方法通常分为两类，即**自上而下**分析方法和**自下而上**分析方法。

- 自上而下分析法：**从文法的开始符号出发**，根据文法的规则进行推导，最终推导出给定的句子来。

  ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/84.png)

- 自下而上分析法：**从给定的输入串开始**，根据文法规则逐步进行归约，直至归约到文法的开始符号为止。

  ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/85.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/86.png)

##### 文法左递归问题

一个文法是含有左递归的，如果存在非终结符 P1

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/87.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/89.png)
...
> 直接左递归的消除
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/90.png)
>
> 间接左递归的消除
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/91.png)
>
> <br>
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/92.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/93.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/94.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/95.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/96.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/97.png)

#### LL(1)分析表的构造

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/98.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/99.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/100.png)
...
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/101.png)
...
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/102.png)
>
> 视频：https://www.bilibili.com/video/BV11t411V74n?t=2384.1&p=14
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/88.png)
...
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/103.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/104.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/82.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/114.png)
...
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/105.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/106.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/107.png)

#### 构造优先关系表

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/111.png)

为了找出所有满足关系“ ⋖ ”和“ ⋗ ”的终结符对，我们需要对G[S]的每个非终结符P构造两个集合FIRSTVT(P)和LASTVT(P)：

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/108.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/109.png)

**LASTVT集的构造方法**：

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/110.png)

> 其它例子：https://www.bilibili.com/video/BV11t411V74n?t=1942.8&p=19
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/112.png)
>
> <br>
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/113.png)
>
> <br>
>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/107.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/115.png)

 查找最左素短语的方法：

1. 最左子串法

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/116.png)

2. 语法树法

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/117.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/118.png)
...
- 许多优先关系表不存在对应的优先函数。
  ...
  ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/119.png)
...
1. 关系图法
   ...
   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/120.png)

2. 直接构造

   ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/121.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/122.png)

LR分析器的核心是一张分析表

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/123.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/124.png)

输入串i+i*i的归约过程用语法树表示，如下图所示。

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/125.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/126.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/127.png)

由于产生式的项目与识别NFA的状态相对应，因此可以用项目来构造NFA。

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/128.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/129.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/130.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/131.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/132.png)

##### LR(0)分析表的构造

::: tip 拓广文法

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/133.png)
...
![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/134.png)

![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/135.png)

由于假定LR(0)文法规范族的每个项目集不含冲突项目，因此按上述方法构造的分析表的每个入口都是惟一的(即不含多重定义)。

我们称如此构造的分析表是一张LR(0)表，使用LR(0)表的分析器叫做一个LR(0)分析器。

> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/136.png)
> <br>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/137.png)
>
> <br>
> ![](https://cdn.jsdelivr.net/gh/kisssssssss/IMG/docs/计算机/编译原理/138.png)
