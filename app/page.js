...
export default async function APP() {
	...
	return (
		<main className='sm:max-w-[512px] md:max-w-[614px] lg:max-w-[820px] xl:max-w-[1024px] 2xl:max-w-[1229px] mx-auto flex flex-col lg:flex-row lg:mt-32 xl:mt-36 2xl:mt-40'>
